    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-lg-9">
          <div className="row">
            {popularDestination.slice(6, 14).map((singleData) => (
              <PackageCart singleData={singleData} key={Math.random()} />
            ))}
          </div>
        </div>
        ...
        <div className="col-lg-3">
          <div className={`card ${styles.tourSiteCard}`}>
            <div className="card-body">
              <h5 className={`card-title ${styles.siteTitle}`}>
                Find your tour
              </h5>
              <form>
                <div className="mb-3">
                  <label
                    ...
                    className={`form-label ${styles.lavel}`}
                  >
                    Where:
                  </label>
                  <input
