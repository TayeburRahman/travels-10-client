          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="d-flex align-items-end">
                <button
                  onClick={() => handleBookNow(tours)}
                  className={`btn me-2 ${styles.singleTourBtn}`}
                >
                  Book Now
                </button>
                <button
                  onClick={() => handleHostContact()}
                  className={`btn ${styles.singleTourBtn}`}
                >
                  Conact Host
                </button>
              </div>
