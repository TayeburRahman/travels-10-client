    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-8">
          {BlogData.slice(3, 100).map((singleData) => (
            <BlogCart singleData={singleData} key={Math.random()} />
          ))}
        </div>
            ...
            <div className="card-body">
              <form className="d-flex mt-3">
                <input
                  ...
                  aria-label="Search"
                />
                <button className={`btn ${styles.siteBarBtn}`} type="submit">
                  Search
                </button>
              </form>
              ...
              <p className={styles.bloggerMessage}>
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
              </p>

              <hr className="my-4" />
              <a href="#" className={`btn d-block ${styles.siteBarBtn}`}>
                <h5>Populra Posts</h5>
              </a>
              ...
              <div className="d-flex my-3">
                ...
                <div className="my-auto">
                  <h6 className={styles.recentPostTitle}>
